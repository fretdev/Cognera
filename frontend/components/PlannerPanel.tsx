      ...
      <div className="mt-5 grid grid-cols-2 gap-2.5 sm:grid-cols-4 sm:gap-3">
        ...
        >
          <div className="flex items-center justify-between text-[var(--t3)]">
            ...
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[var(--accent-soft)] border border-[var(--accent-border)]">
        ...
        >
          <div className="flex items-center justify-between text-[var(--t3)]">
            ...
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[var(--s2)] border border-[var(--b2)]">
              <Clock size={13} strokeWidth={1.75} className="text-[var(--t2)]" />
            </div>
          </div>
        ...
        >
          <div className="flex items-center justify-between text-[var(--t3)]">
            ...
            <div className="flex h-6 w-6 items-center justify-center rounded-lg bg-[var(--s2)] border border-[var(--b2)]">
              <CheckCircle2 size={13} strokeWidth={1.75} className="text-[var(--t2)]" />
            </div>
          </div>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {examCountdowns.map((exam) => {
              ...
              return (
                <div
                  key={exam.id}
                  className="rounded-2xl p-4 flex flex-col justify-between transition-all hover:border-[var(--accent-border)]"
                  style={{
                    background: "var(--s1)",
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="min-w-0 pr-2">
                      <span className="inline-flex items-center gap-1 rounded-md bg-[var(--accent-soft)] px-2 py-0.5 text-[10px] font-semibold text-[var(--accent)] border border-[var(--accent-border)] uppercase tracking-wider">
                        <Flame size={10} className="text-[var(--accent)]" /> Exam
                      </span>
                    ...
                    <button
                      ...
                      className="text-xs font-medium text-[var(--accent)] hover:opacity-80 shrink-0"
                    >
                      Done
                    </button>
                  </div>
                  ...
                  <div className="mt-3.5 grid grid-cols-4 gap-1 text-center">
                    ...
                    <div className="rounded-xl bg-[var(--s2)] py-1.5 border border-[var(--b1)]">
                      <div className="text-sm font-semibold text-[var(--accent)] sm:text-base">{cd.seconds}</div>
                        ...
                        <div className="flex items-center gap-2 flex-wrap">
                          ...
                          <span
                            className={`inline-flex items-center gap-1 rounded-md px-2 py-0.5 text-[10px] font-medium uppercase tracking-wider ${
                              isExam
                                ? "bg-[var(--accent-soft)] text-[var(--accent)] border border-[var(--accent-border)]"
                                : "bg-[var(--s3)] text-[var(--t2)] border border-[var(--b2)]"
                            }`}
                          >
                            {isExam && <Flame size={10} className="text-[var(--accent)]" />}
                            {isAssignment && <Tag size={10} className="text-[var(--t3)]" />}
                            {isSession && <Clock size={10} className="text-[var(--t3)]" />}
